const { createCarrito, selectCarritos, selectCarrById, updateCarrito, deleteCarrito } = require('../daos/db/dbCarrMongo.js')
const { createProducto, selectProductos, selectProdById, updateProducto, deleteProducto } = require('../daos/db/dbProdMongo.js')

const ejecutarCarrMng = async (opcion, parametro) => {
...
module.exports.ejecutarCarrMng = ejecutarCarrMng